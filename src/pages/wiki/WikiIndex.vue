<template>
  <div class="px-10 py-6">
    ...
    <div class="mt-3 topic">
      ...
      <p>
        В настоящее время реализован функционал блока <b>Академия.MEDEQ</b>.
      </p>
      <p>
      ...
      <p>
        Но, как говорится, одним функционалом сыт не будешь, поэтому нам понадобится еще некоторое время, чтобы заполнить данный блок корректной и, главное, актуальной информацией! Но уже сейчас вы сможете найти для себя что-то интересное.
      </p>
      <p>
