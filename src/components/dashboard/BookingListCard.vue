<template>
  <v-card>
    <v-card-title class="pt-5">
      <div style="position: absolute; left: 0; top: 10px; color: #fff; padding: 0 8px; height: 24px; line-height: 24px; font-size: 1rem;" class="green darken-3">
        авторизация
      </div>
      <div>Проекты на одобрении ({{ projects.length }})</div>
    </v-card-title>
...
export default {
  ...
  data () {
    return {
      ...
      project: null,
      projects: [
        { icon: 'folder', iconClass: 'grey lighten-1 white--text', title: '#3239', subtitle: 'Артем Карамышев, ИНН 20329439434' },
        { icon: 'folder', iconClass: 'grey lighten-1 white--text', title: '#3239', subtitle: 'Артем Карамышев, ИНН 20329439434' },
        { icon: 'folder', iconClass: 'grey lighten-1 white--text', title: '#3239', subtitle: 'Артем Карамышев, ИНН 20329439434' },
        { icon: 'folder', iconClass: 'grey lighten-1 white--text', title: '#3239', subtitle: 'Артем Карамышев, ИНН 20329439434' },
        { icon: 'folder', iconClass: 'grey lighten-1 white--text', title: '#3239', subtitle: 'Артем Карамышев, ИНН 20329439434' },
